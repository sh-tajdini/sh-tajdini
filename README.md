...
I am a skilled front-end developer with over five years of experience working with JavaScript, HTML5, CSS3, and React. I have expertise in building progressive web applications and responsive websites, and I am proficient in managing all phases of the Software Development Life Cycle (SDLC) efficiently. I am keen to improve my front-end skills further by learning new technologies such as SWR, Typescript, and TDD. I am seeking opportunities to contribute my expertise to a company with an innovative product and a work environment that encourages exceptional work.

As a front-end developer at Daylite.ai, I led the website's migration to ReactJs and NextJS platforms, which improved user experience and increased maintenance efficiency. Additionally, I played a crucial role in optimizing the website's performance through various techniques, including image optimization, lazy loading, caching, WebSocket integration, and server-side rendering. These optimizations significantly decreased website load time. We could effectively manipulate datasets by collaborating closely with the development team and utilizing RESTful APIs.

One of my notable achievements at Daylite was implementing comprehensive testing strategies using Cypress and Jest, a move that led to a 15% decrease in critical bugs and issues reported by clients. Additionally, I worked closely with our designer to redesign the website, a task that resulted in a remarkable increase in the conversion rate from 3% to 10%. I also integrated the ChatGPT API to extract and process data, a solution that led to a 30% improvement in response accuracy, showcasing my problem-solving skills.

During my tenure at Pasargad Electronic Payment, I demonstrated my leadership skills by effectively managing a team of 10 developers and designers, ensuring smooth collaboration and successful project execution. I actively participated in the design and development of ReactJs-based solutions for over 20 clients, delivering high-quality products. My optimization efforts for mobile devices increased mobile user engagement by 20%. I also played a pivotal role in launching the development infrastructure (CI/CD), saving 40 monthly hours on repetitive tasks.
